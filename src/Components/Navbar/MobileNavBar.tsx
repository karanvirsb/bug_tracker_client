...
const MobileNavBar = () => {
    ...
    return (
        <header
            className={`md:block m-md:hidden bg-main-color text-white fixed rounded-t-2xl rounded-tr-2xl p-4 flex flex-col top-[50%] left-0 right-0 bottom-0 overflow-auto ${
                showNavigation
                    ? "  md:items-center  w-full md:-z-1"
